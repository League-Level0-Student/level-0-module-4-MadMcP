...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>Which is not classified as a fruit? <br> A: Cucumber <br> B: Mango <br> C: Banana</html>");
		question3 = new JLabel("<html>What makes a food a fruit? <br> A: Sweetness <br> B: Shape <br> C: Seeds</html>");
		question4 = new JLabel("<html>Which fruit was once thought to be poisonous? <br> A: Peach <br> B: Tomato <br> C: Plum</html>");	
	}
	...
	public void keyPressed(KeyEvent arg0) {
		...
		if (question4.isShowing()) {
			if (keyCode==b) {
				correct();
				JOptionPane.showMessageDialog(null, "You completed the Fruit Quiz!");
			}
			else {
				incorrect();
			}
